  ...
  return (
    <div>
      ...
      <div className="bg-whiteColor shadow-lg mb-28">
        <div className="flex flex-col justify-center text-center mb-[5vh] mx-auto mt-10">
          <h1 className="font-light  w-2/4 md:w-11/12 mx-auto text-gray-600 text-lg">
            {t('contactUsText')}
        ...
        <div className="flex flex-row gap-2 md:flex-wrap w-11/12 mx-auto">
